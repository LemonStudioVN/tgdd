...
<body>
    ...
    <nav class="mobile-menu">
        ...
        <ul>
            ...
            <li>
                <a href="women-shop.html">Women</a>
            </li>
            <li>
    ...
    <!-- MAIN MENU -->
    <nav id="main-menu">
        <img class="pull-nav" src="img/icons/pull-icon.png" alt="pull-icon">
        <ul>
                    ...
                    <li>
                        ...
                        <article class="submenu-list">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="men-shop.html">Custom Caps
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="men-shop.html">Backpacks
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="men-shop.html">Headphones
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                        ...
                        <article class="submenu-list">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="women-shop.html">Custom Caps
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="women-shop.html">Sneakers
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="women-shop.html">Backpacks
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="women-shop.html">Headphones
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                        ...
                        <ul class="product-preview">
                            ...
                            <li>
                                <a href="full-view.html">
                                    <figure class="liquid">
                                        <img src="img/items/25.png" alt="product2">
                                    </figure>
                                </a>
                                <a href="women-shop.html"><p class="highlighted category">T-Shirts</p></a>
            ...
            <li>
                ...
                <ul class="submenu-large">
                    <li>
                        ...
                        <article class="submenu-list">
                            <figure class="liquid">
                                <img src="img/items/16.png" alt="product-wide">
                            </figure>
                            <h6>Custom Men</h6>
                            <ul>
                                <li>
                        ...
                        <article class="submenu-list">
                            <figure class="liquid">
                                <img src="img/items/02.png" alt="product-wide">
                            </figure>
                            <h6>Custom Women</h6>
                            <ul>
                                <li>
                        ...
                        <article class="submenu-list">
                            <figure class="liquid">
                                <img src="img/items/38.png" alt="product-wide">
                            </figure>
                            <h6>Miscelaneous</h6>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a href="merchandising-shop.html">Summer Collection
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="merchandising-shop.html">Back to School
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="merchandising-shop.html">Skate or Die
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="merchandising-shop.html">Surf Season
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                                ...
                                <li>
                                    <a href="merchandising-shop.html">Anime Collection
                                    <!-- SVG ARROW -->
                                    <svg class="svg-arrow">
                                        <use xlink:href="#svg-arrow"></use>
                                    </svg>
                        ...
                        <ul class="product-preview">
                            <li>
                                <a href="full-view.html">
                                    <figure class="liquid">
                                        <img src="img/items/31.png" alt="product1">
                                    </figure>
                                </a>
                            ...
                            <li>
                                <a href="full-view.html">
                                    <figure class="liquid">
                                        <img src="img/items/16.png" alt="product1">
                                    </figure>
                                </a>
                            ...
                            <li>
                                <a href="full-view.html">
                                    <figure class="liquid">
                                        <img src="img/items/07.png" alt="product1">
                                    </figure>
                                </a>
                                <a href="women-shop.html"><p class="highlighted category">T-Shirts</p></a>
    ...
    <div class="product-showcase-wrap">
        <section class="product-showcase">
            ...
            <div id="compare-modal" class="compare-modal mfp-with-anim mfp-hide">
                <img src="img/icons/compare-modal-logo.png" alt="logo">
            ...
            <ul id="owl-f-products" class="product-list grid owl-carousel">
                            ...
                            <div id="qv-p1" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/02.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        ...
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/02.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                        ...
                                        <li>
                                            <figure class="liquid">
                                                <img src="img/items/01.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/15.png" alt="product">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p2" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    ...
                                    <ul class="picture-views">
                                        ...
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/15.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/35.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p3" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/35.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/35.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                        ...
                        <div>
                            ...
                            <div id="qv-p4" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/31.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/31.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/09.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p5" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/09.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/09.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                                ...
                                <div class="product-description">
                                    ...
                                    <!-- /RATING -->
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod eru tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim darea veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea loremn commodo consequat. Duis aute irure dolor in.</p>
                                    <p class="highlighted current">$84.00</p>
                                    <h5 class="stock">Availability:
                                        <!-- SVG CHECK -->
                                        <svg class="svg-check">
                                            <use xlink:href="#svg-check"></use>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/39.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p6" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/39.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/39.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                                ...
                                <!-- PRODUCT DESCRIPTION -->
                                <div class="product-description">
                                    <a href="#"><p class="highlighted category">Prints</p></a>
                                    <a href="#"><h6>Halloween Party</h6></a>
                                    <!-- RATING -->
                                    <ul class="rating big">
                                        <li class="filled">
                                            <!-- SVG STAR -->
                                    ...
                                    <!-- /RATING -->
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod eru tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim darea veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea loremn commodo consequat. Duis aute irure dolor in.</p>
                                    <p class="highlighted current">$16.00</p>
                                    <h5 class="stock">Availability:
                                        <!-- SVG CHECK -->
                                        <svg class="svg-check">
                                            <use xlink:href="#svg-check"></use>
        ...
        <section class="product-showcase">
            ...
            <ul id="owl-bs-products" class="product-list grid owl-carousel">
                        ...
                        <div>
                            ...
                            <div id="qv-p7" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/33.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/33.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/25.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p8" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/25.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/25.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/04.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p9" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/04.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/04.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                        ...
                        <div>
                            ...
                            <div id="qv-p10" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/07.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/07.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/37.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p11" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/37.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/37.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
                ...
                <li class="list-item">
                    ...
                    <div class="actions">
                        <figure class="liquid">
                            <img src="img/items/34.png" alt="product1">
                        </figure>
                        <div>
                            ...
                            <div id="qv-p12" class="product-quick-view mfp-with-anim mfp-hide">
                                ...
                                <div class="product-pictures">
                                    <div class="product-photo">
                                        <figure class="liquid">
                                            <img src="img/items/34.png" alt="product-image">
                                        </figure>
                                    </div>
                                    <ul class="picture-views">
                                        <!-- VIEW -->
                                        <li class="selected">
                                            <figure class="liquid">
                                                <img src="img/items/34.png" alt="picture-view">
                                            </figure>
                                        </li>
                                        <!-- /VIEW -->
                                    </ul>
            ...
            <div class="slidable">
                ...
                <ul id="owl-blog-posts" class="blog-post-preview grid owl-carousel">
                    ...
                    <li class="list-item">
                        <a href="post.html">
                            <figure>
                                <img src="img/blog/post3.jpg" alt="post3">
                            </figure>
                        </a>
                        <div class="content">
                    ...
                    <li class="list-item">
                        <a href="post.html">
                            <figure>
                                <img src="img/blog/post4.jpg" alt="post4">
                            </figure>
                        </a>
                        <div class="content">
    ...
    <div id="billboard-wrap">
        <section id="billboard">
            ...
            <div class="sale-promo">
                ...
                <img src="img/bunny-monster.png" alt="bunny-monster">
                <div id="bubbles">
        ...
        <section id="brands">
            ...
            <div class="slidable">
                ...
                <ul id="owl-brands" class="brands-list owl-carousel">
                    ...
                    <li>
                        <a href="#">
                            <img src="img/brands/gr.png" alt="brand-normal">
                            <img src="img/brands/gr-over.png" alt="brand-over">
                        </a>
                    </li>
                    <!-- /BRAND -->
                    ...
                    <li>
                        <a href="#">
                            <img src="img/brands/tf.png" alt="brand-normal">
                            <img src="img/brands/tf-over.png" alt="brand-over">
                        </a>
                    </li>
                    <!-- /BRAND -->
                    ...
                    <li>
                        <a href="#">
                            <img src="img/brands/aj.png" alt="brand-normal">
                            <img src="img/brands/aj-over.png" alt="brand-over">
                        </a>
                    </li>
                    <!-- /BRAND -->
                    ...
                    <li>
                        <a href="#">
                            <img src="img/brands/vh.png" alt="brand-normal">
                            <img src="img/brands/vh-over.png" alt="brand-over">
                        </a>
                    </li>
                    <!-- /BRAND -->
                    ...
                    <li>
                        <a href="#">
                            <img src="img/brands/pd.png" alt="brand-normal">
                            <img src="img/brands/pd-over.png" alt="brand-over">
                        </a>
                    </li>
                    <!-- /BRAND -->
            ...
            <section id="footer-top" class="clearfix">
                <article>
                    ...
                    <ul class="payment-methods">
                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method1.jpg" alt="method1">
                        </li>
                        <!-- /METHOD -->

                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method2.jpg" alt="method2">
                        </li>
                        <!-- /METHOD -->

                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method3.jpg" alt="method3">
                        </li>
                        <!-- /METHOD -->

                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method4.jpg" alt="method4">
                        </li>
                        <!-- /METHOD -->

                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method5.jpg" alt="method5">
                        </li>
                        <!-- /METHOD -->

                        <!-- METHOD -->
                        <li>
                            <img src="img/payment/method6.jpg" alt="method6">
                        </li>
                        <!-- /METHOD -->
                    </ul>
                    <!-- /PAYMENT METHODS -->
                ...
                <article>
                    ...
                    <ul class="product-preview">
                        ...
                        <li>
                            <a href="full-view.html">
                                <figure class="liquid">
                                    <img src="img/items/32.png" alt="product3">
                                </figure>
                            </a>
                            <a href="women-shop.html"><p class="highlighted category">Custom Sneakers</p></a>
